...
const LostItemSubmit = () => {
  ...
  const lostItemFormSubmit = () => {
    ...
    return lostItemSubmission(finalItem).then(() => {
      ...
      if (campusUser?.role === "Admin") { // Logic now works correctly
        navigate("/AdminMenu");
      } else {
        ...
        <form onSubmit={handleValidation}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
            <div className="space-y-6">
              ...
              <div>
                <label htmlFor="lostDate" className={labelStyles}>Select Lost Date *</label>
                <input id="lostDate" type="date" className={inputStyles} value={ldate} onChange={(e) => setLdate(e.target.value)} />
              ...
              <div>
                ...
                <input id="entryDate" type="date" className={inputStyles} value={edate} onChange={(e) => setEdate(e.target.value)} />
            ...
            <div className="space-y-6">
              ...
              <div>
                <label htmlFor="location" className={labelStyles}>Location Where it was Lost *</label>
