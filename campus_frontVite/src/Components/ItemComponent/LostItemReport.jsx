...
import { FaSearch, FaRegSadTear, FaTimes, FaComments } from "react-icons/fa";
            ...
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-100">
                <tr>
                  ...
                  {/* Action columns only for Student */}
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {lostItems.map((item) => (
                  ...
                  >
                    ...
                    {/* Chat and Mark as Found - Only for Student */}
                    {currentUser?.role === "Student" && (
                      <>
                        <td className="px-6 py-4 text-sm">
                          <button
                            onClick={() => handleChat(item.username)}
