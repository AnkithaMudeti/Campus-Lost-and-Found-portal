...
import { ChevronDown, Package, FileText, MapPin, User, LogOut, Bell, Settings, Menu, X } from "lucide-react";
  ...
  const menuItems = [
    {
      title: "Profile",
      icon: User,
      items: [{ name: "Personal Info", href: "/Personal", icon: User }],
    },
    {
      title: "Items",
      icon: Package,
      items: [
        ...
        { name: "Found Item Submission", href: "/FoundSubmit", icon: MapPin },
      ],
    },
    {
      title: "Reports",
